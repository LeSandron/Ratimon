...
public class RatDatabase
{
    ...
    private void InitializeDatabase()
    {
        ...
        Rats.Add(new RatInformation { ratName = "Rattack", ratHp = 35,ratMaxHp=35*2, ratAttack = 50, ratDefense = 45, ratSpeed = 20, Sprite = Resources.Load<Sprite>("Sprites/Rattack") });
        Rats.Add(new RatInformation { ratName = "Ratbat", ratHp = 45,ratMaxHp=45*2, ratAttack = 20, ratDefense = 65, ratSpeed = 10, Sprite = Resources.Load<Sprite>("Sprites/Ratbat") });
    }
